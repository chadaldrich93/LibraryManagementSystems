...
public class LMSDataAccessObject {
	...
	public static void addAuthor(Author data) throws FileNotFoundException, IOException {
		BufferedWriter writer = new BufferedWriter(new FileWriter(Authors, true));
		writer.write(data.toString());
		writer.newLine();
		writer.close();
	}

	public static void addBook(Book data) throws FileNotFoundException, IOException {
	...
	public static void addPublisher(Publisher data) throws FileNotFoundException, IOException {
		BufferedWriter writer = new BufferedWriter(new FileWriter(Publishers, true));
		writer.write(data.toString());
		writer.newLine();
		writer.close();
	}
	...
	public static void updateAuthors(ArrayList<Author> authorList) throws FileNotFoundException, IOException {
	...
	public static void updateBooks(ArrayList<Book> bookList) throws FileNotFoundException, IOException {
	...
	public static void updatePublishers(ArrayList<Publisher> publisherList) throws FileNotFoundException, IOException {
	...
	public static void readAuthorListFromFile(ArrayList<Author> authorList) throws FileNotFoundException, IOException {
		authorList.clear();
		Author temp;
	...
	public static void readBookListFromFile(ArrayList<Book> bookList) throws FileNotFoundException, IOException {
		bookList.clear();
		Book temp;
	...
	public static void readPublisherListFromFile(ArrayList<Publisher> publisherList)
	...
	private static Book convertCsvStringToBook(String csv) {
		...
		int publisherId = Integer.parseInt(csvStringAsArray[PUBLISHERID_INDEX]);
