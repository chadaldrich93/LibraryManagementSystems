...
public class LMSService {
	...
	public static void addAuthorToList(Author data) throws IOException {
		...
		if (findAuthorInList(id) != OBJECT_NOT_FOUND) {
			System.out.println("Invalid addition, value with id " + id + " already exists in Authors file");
			return;
		}
		authorList.add(data);
	...
	public static void addBookToList(Book data) throws IOException {
		...
		if (findBookInList(bookId) != OBJECT_NOT_FOUND) {
			System.out.println("Invalid addition, book with id " + bookId + " already exists in Books file");
			return;
		}
		if (findAuthorInList(authorId) == OBJECT_NOT_FOUND) {
			System.out.println("Invalid addition, author with id " + authorId + " does not exist in Authors file");
			return;
		}
		if (findPublisherInList(publisherId) == OBJECT_NOT_FOUND) {
			System.out.println(
					"Invalid addition, publisher with id " + publisherId + " does not exist in " + "Publishers file");
			return;
		}
		bookList.add(data);
	...
	public static void addPublisherToList(Publisher data) throws IOException {
		...
		if (findPublisherInList(id) != OBJECT_NOT_FOUND) {
			System.out.println("Invalid addition, publisher with id " + id + " already exists in Publishers file");
			return;
		}
	...
	public static void removeBookFromList(int bookId) throws IOException {
		...
		if (index == OBJECT_NOT_FOUND) {
			System.out.println("Invalid removal, book with id " + bookId + " was not found");
			return;
		}
	...
	public static void removeAuthorFromList(int authorId) throws IOException {
		...
		if (index == OBJECT_NOT_FOUND) {
			System.out.println("Invalid removal, author with id " + authorId + " was not found");
			return;
		}
	...
	public static void removePublisherFromList(int publisherId) throws IOException {
		int index = findPublisherInList(publisherId);
		if (index == OBJECT_NOT_FOUND) {
			System.out.println("Invalid removal, book with id " + publisherId + " was not found");
			return;
		}
	...
	public static void updateAuthorInList(Author newAuthor) throws IOException {
		...
		if (index == OBJECT_NOT_FOUND) {
			System.out.println("Invalid update, author with id " + id + " was not found");
			return;
		}
		authorList.remove(index);
	...
	public static void updateBookInList(Book newBook) throws IOException {
		...
		if (index == OBJECT_NOT_FOUND) {
			System.out.println("Invalid update, book with id " + id + " was not found");
			return;
		}
		Book oldBook = retrieveBook(id);
		if (newBook.getAuthorId() != oldBook.getAuthorId()) {
			System.out.println("Invalid update, author id can not be " + " changed from " + oldBook.getAuthorId()
					+ " to " + newBook.getAuthorId());
			return;
		}
		if (newBook.getPublisherId() != oldBook.getPublisherId()) {
			System.out.println("Invalid update, publisher id can not be " + " changed from " + oldBook.getPublisherId()
	...
	public static void updatePublisherInList(Publisher newPublisher) throws IOException {
	...
	public static Author retrieveAuthor(int id) {
		int index = findAuthorInList(id);
		if (index == OBJECT_NOT_FOUND) {
			System.out.println("Invalid retrieval, author with id " + id + " was not found.");
			return null;
		}
	...
	public static Book retrieveBook(int id) {
		int index = findBookInList(id);
		if (index == OBJECT_NOT_FOUND) {
			System.out.println("Invalid retrieval, book with id " + id + " was not found.");
			return null;
		}
	...
	public static Publisher retrievePublisher(int id) {
		int index = findPublisherInList(id);
		if (index == OBJECT_NOT_FOUND) {
			System.out.println("Invalid retrieval, publisher with id " + id + " was not found.");
			return null;
		}
